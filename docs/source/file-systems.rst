...
ты можешь найти `тут 
<https://raid6.com.au/posts/fs_ext4_external_journal/>`_.
...
Если ты используешь внешний журнал, то оптимальными параметрами будут:
...
<https://www.man7.org/linux/man-pages/man5/ext4.5.html>`_.
