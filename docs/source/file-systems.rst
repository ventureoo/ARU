...
После выставления данныго флага монтирования новые файлы начнут сжиматься при записи на диск. Для сжатия уже имующихся данных необходино произвести выполнить команду:
::
...
для сжатия папки или раздела необходимо указать ключ *-r* перед *-calg*
