...
Для этого расскоментируем так называемый *multilib* репозиторий::
...
В гайде мы установим драйвер версии DKMS, который сам подстроиться под нужное ядро и не позволит убить систему при обновлении
...
(Это измнение профиля питания видеокарты работает только до перезагрузки.
...
Указать вы их можете либо в Lutris для конкретных игр или в "Свойствах игры" в Steam.
