...
``_tickless="1"`` - Рекомендуется выбирать переодические тики таймера ядра.
...
Рекомедуется лучше выбирать переодические тики (*"Idle dynticks system"*), ибо на практике оказывается что периодические тики
