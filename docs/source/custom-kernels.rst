...
операционных систем, которое одинаково подоходит как для домашнего ПК, ноутбука, телефона, так и для сервера, роутера, микро-контроллера.
...
Zen ядро - это плод коллективных усилий по объединеню патчей улучшающих опыт домашнего использования
...
- Содержит минималное количество отладочных функций.
- Другие внутренные изменения ядра.
...
Тонкая настрйка ядра позволит дать ещё больше производительности и может
...
с ядром это особенно важно, ибо ядро это сердце операционной системы, и если его нативно собрать под себя то мы получем существенный
...
**2.** Изменимим поведение таймера ядра.
...
- Full dynticks system - прерывания через чатсоту тика N, но не всегда, даже если процессор чем-то занят.
...
Это значит, что теоритически у вас не будет тратиться время на выход таймера из "сна".
И на практике оказывается что переодические тики дают лучшую производительность в играх и мультимедиа.
...
**4.** Рекомендуем вам отключать отладочные функции ядра. Они тоже имеют свои наклодные расходы и в большинстве случаев
