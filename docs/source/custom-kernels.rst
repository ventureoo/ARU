...
- Если в списке есть ``x86_64-v3 (supported, searched)`` - значит ваш процессор поддерживает x86_64v3 микроархитектуру

- Если же в списке ``x86_64-v2 (supported, searched)`` - ваш процецессор поддерживает x86_64v2 микроархитектуру

- Если команда ничего не выдала - процессор поддерживает лишь базовую x86_64
