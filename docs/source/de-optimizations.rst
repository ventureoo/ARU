...
темы на лету. Если отключить, то смена GTK темы будет применяться
...
# Отключение службы интеграции Cinnamon с картридером. Если у вас его
нет смело, отключайте::
...
# Отключение службы настройки энергосбережения Cinnamon. Смело
отключаем, если у вас не ноутбук::
