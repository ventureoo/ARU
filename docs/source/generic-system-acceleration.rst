...
.. attention:: Поскольку ОЗУ это энергозависимая память, то при перезагрузке или отключении питания все файлы, полученные во время сборки будут утеряны! Может понадобиться параметр PKGDEST для указания директории для собранного пакета.
