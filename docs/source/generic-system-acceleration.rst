...
Обновление ключей необходимо во избежания проблем с установкой пакетов::
...
Multilib репозиторий необходим для установки 32-битных приложений, в частности для Wine и Steam::
...
В остальных случаях лучше использовать Российские зеркала или другие, в зависимости от вашего местопложения::

  sudo reflector --verbose --country 'Russia' -l 25 --sort rate --save /etc/pacman.d/mirrorlist

Можно также вручную отредактировать список зеркал,
добавив туда зеркала из постоянно обновляющегося перечня на сайте Arch Linux (https://archlinux.org/mirrorlist/)::
