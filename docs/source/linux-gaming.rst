...
которых и активирует данная опция. Крайне рекомендуется к включению, так как
позволяет получить серьёзный прирост производительности вплоть до 678%
процентов [#]_ в некоторых играх по сравнению с обычной, однопоточной
реализацией в wineserver.
