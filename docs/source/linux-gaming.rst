...
* Включить запуск игры через PROTON EXPERIMENTAL в Steam (поддержка для игр с dx-11 и DX-12 включена в Proton-6.3-8 и **PROTON-GE-CUSTOM не поддержавается на данный момент!**).
