...
---------------------------
Продвинутое масшабирование
---------------------------

На данный момент имеются два алгоритма масштабирования с повышением производительности: общедоступная FidelityFX Super Resolution (FSR) от AMD и исключительно для видеокарт NVIDIA - Deep learning super sampling (DLSS).
...
* Видеокарта поддерживающая данную технологию (видеокарты от NVIDIA серии RTX).
* Включить запуск игры через PROTON EXPERIMENTAL в Steam (**PROTON-GE-CUSTOM не поддержавается на данный момент!**).
