...
.. warning:: DXVK осуществляет ретрансляцию вызовов только игр использующих версии DirectX 9, 10 и 11!
   Для DirectX 12 для понадобиться устанавливать другой ретранслятор кода, если точнее то - vkd3d. Подробнее о нем вы можете прочитать ниже.
...
vkd3d - это аналог DXVK, но уже конкретно для версии DirectX 12.
