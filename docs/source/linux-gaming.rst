...
.. todo:: Удалить в будущем. Патчи для разделяемой памяти были слиты в
   upstream и работают по умолчанию:
   https://github.com/wine-staging/wine-staging/commit/d2c868d8c98daf7b3de692217571482a1e363444
