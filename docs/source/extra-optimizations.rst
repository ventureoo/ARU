...
=============================
Уменьшение нагрузки на IO 
=============================

В Linux можно уменьшить количество обращений к хранилищу данных (HDD или SSD) если перенести директорию .cache в ОЗУ. Для этого у вас должна директория /tmp должна использрвать tmpfs.
Для переноса .cache в ОЗУ достаточно создать скрипт со следующим содержимым 
